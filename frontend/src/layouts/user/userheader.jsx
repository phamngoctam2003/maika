            ...
            <header>
                ...
                <div className="maka1">
                    <nav className="navigation">
                        <a href="sachdientu.php" className="pgp">Sách điện tử</a>
                        <a href="sachnoi.php" id="About" className="pgp">Sách nói</a>
                        <a href="sachhieusoi.php" className="pgp">Sách hiệu sồi</a>
                        <a href="sachdientu.phpc" className="pgp">Sách tóm tắt</a>
                    </nav>
                </div>
                <div className="nav1-c">
                    ...
                    <div className="goicuoc">
                        <a href="#"><button>Gói Cước</button></a>
                    </div>
                    <div className="form-submit">
                        {loggedIn ? (
                            ...
                            <a href="#"><button ref={btnCuasoRef} className="btnLogin-popup" onClick={handlePopupClick}>Đăng Nhập</button></a>
                        )}
                        ...
                        {loggedIn && (
                            <div className="admin-khachhang">
                                ...
                                <button className="hoivien-aac"><a href="#">Trở thành hội viên</a></button>
                                <div className="flex-p">
                                    <div className="icon-flex">
                                        <a href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25" fill="currentColor"><path d="M4 22C4 17.5817 7.58172 14 12 14C16.4183 14 20 17.5817 20 22H4ZM12 13C8.685 13 6 10.315 6 7C6 3.685 8.685 1 12 1C15.315 1 18 3.685 18 7C18 10.315 15.315 13 12 13Z"></path></svg>
                                            <p>Quản lý tài khoản</p></a></div>
                                    <div className="icon-flex">
                                        <a href="tusach.php"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25" fill="currentColor"><path d="M4 3C3.44772 3 3 3.44772 3 4V20C3 20.5523 3.44772 21 4 21H14C14.5523 21 15 20.5523 15 20V15.2973L15.9995 19.9996C16.1143 20.5398 16.6454 20.8847 17.1856 20.7699L21.0982 19.9382C21.6384 19.8234 21.9832 19.2924 21.8684 18.7522L18.9576 5.0581C18.8428 4.51788 18.3118 4.17304 17.7716 4.28786L14.9927 4.87853C14.9328 4.38353 14.5112 4 14 4H10C10 3.44772 9.55228 3 9 3H4ZM10 6H13V14H10V6ZM10 19V16H13V19H10ZM8 5V15H5V5H8ZM8 17V19H5V17H8ZM17.3321 16.6496L19.2884 16.2338L19.7042 18.1898L17.7479 18.6057L17.3321 16.6496ZM16.9163 14.6933L15.253 6.86789L17.2092 6.45207L18.8726 14.2775L16.9163 14.6933Z"></path></svg>
                                            <p>Tủ sách cá nhân</p></a></div>
                                    <div className="icon-flex">
                                        <a href="lich_su.php"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25" fill="currentColor"><path d="M2 3.9934C2 3.44476 2.45531 3 2.9918 3H21.0082C21.556 3 22 3.44495 22 3.9934V20.0066C22 20.5552 21.5447 21 21.0082 21H2.9918C2.44405 21 2 20.5551 2 20.0066V3.9934ZM11 5H4V19H11V5ZM13 5V19H20V5H13ZM14 7H19V9H14V7ZM14 10H19V12H14V10Z"></path></svg>
                                            <p>Lịch sử đọc sách</p></a></div>
                                    <div className="icon-flex">
                                        <a href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25" fill="currentColor"><path d="M21 8C22.1046 8 23 8.89543 23 10V14C23 15.1046 22.1046 16 21 16H19.9381C19.446 19.9463 16.0796 23 12 23V21C15.3137 21 18 18.3137 18 15V9C18 5.68629 15.3137 3 12 3C8.68629 3 6 5.68629 6 9V16H3C1.89543 16 1 15.1046 1 14V10C1 8.89543 1.89543 8 3 8H4.06189C4.55399 4.05369 7.92038 1 12 1C16.0796 1 19.446 4.05369 19.9381 8H21ZM7.75944 15.7849L8.81958 14.0887C9.74161 14.6662 10.8318 15 12 15C13.1682 15 14.2584 14.6662 15.1804 14.0887L16.2406 15.7849C15.0112 16.5549 13.5576 17 12 17C10.4424 17 8.98882 16.5549 7.75944 15.7849Z"></path></svg>
                                            <p>Hỗ trợ khách hàng</p></a></div>
                                    <div className="icon-flex">
                                        <a onClick={handleLogout}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25" fill="currentColor"><path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C15.2713 2 18.1757 3.57078 20.0002 5.99923L17.2909 5.99931C15.8807 4.75499 14.0285 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20C14.029 20 15.8816 19.2446 17.2919 17.9998L20.0009 17.9998C18.1765 20.4288 15.2717 22 12 22ZM19 16V13H11V11H19V8L24 12L19 16Z"></path></svg>
                                            <p>Đăng xuất</p></a></div>
                                </div>
                            </div>
                        )}
                        ...
                        {isPopupLogin && (
                            <form className="form-var" method="post" onSubmit={onFinish}>
                                ...
                                <div className="login-register">
                                    <p>không có tài khoản? <a href="#" ref={linkdangkyRef} className="linkdangky" onClick={handleSignupClick}>Đăng Ký</a></p>
                                </div>
                            </form>
                        )}
                    </div>
                    ...
                    <div className="form-logo1">
                        ...
                        {!isPopupLogin && (
                            <form onSubmit={onFinish}>
                                ...
                                <div className="login-register">
                                    <p>Bạn đã có tài khoản? <a href="#" ref={linkdangnhapRef} className="linkdangnhap" onClick={handleLoginClick}>Đăng Nhập</a></p>
                                </div>
                            </form>
                        )}
                    </div>
