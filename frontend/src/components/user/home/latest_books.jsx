...
export const LatestBooks = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            // Nếu response là object có data thì lấy response.data, nếu không thì lấy response luôn
            setLatestBooks(response?.data || response || []);
        } catch (e) {
            setLatestBooks([]);
        }
    };
    ...
    return (
        <div ref={elementRef} className="py-2 lg:py-8 w-full">
            <div className="pl-4 lg:pl-12 w-full">
                <h2 className="text-xl md:text-2xl font-bold mb-2 lg:mb-6">Mới nhất</h2>
