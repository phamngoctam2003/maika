...
const Create_booktype = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: "Thêm Loại Sách", path: null },
    ];
    ...
    const handSubmit = async (e) => {
        ...
        try {
            const res = await BooktypeService.create(data);
            if (res) {
                AntNotification.showNotification("Thêm thành công", "Loại sách đã được thêm thành công!" || res.message, "success");
                navigate("/admin/book-types");
            } else {
                AntNotification.showNotification("Có lỗi xảy ra", "Thêm loại sách thất bại!" || res.message, "error");
        ...
        const fetchCategories = async () => {
            try {
                ...
                if (res) {
                    ...
                    AntNotification.showNotification("Có lỗi xảy ra", "Không thể tải danh sách danh mục!" || res.message, "error");
                }
            } catch (error) {
        ...
        <div className="pt-16 px-4 lg:ml-64">
            ...
            <div className="bg-white shadow rounded-lg mb-4 p-4 h-full">
                ...
                <form className="max-w-lg mt-5" onSubmit={handSubmit}>
                    <div className="mb-5">
                        <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Tên loại sách</label>
                        <input type="text"
                            name="name"
...
export default Create_booktype;