...
const EbookCategory = () => {
    ...
    const fetchBooksByCategory = async (page = 1) => {
        try {
            setLoading(true);
            const response = await EbookService.getEbooksByCategoryPaginated(slug, page, pagination.limit);
    ...
    const pageTitle = `${categoryName} - Sách điện tử | Maika`;
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-16">
                            ...
                            <p className="text-gray-400 mb-6">
                                Danh mục "{categoryName}" hiện chưa có sách điện tử nào.
                            </p>
                            <a
                                href="/ebook"
